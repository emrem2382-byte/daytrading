...
SCREENER_CONFIG = {
    "most_actives": 40,
    "day_gainers": 50,   # "топ 50 най-качили-се за деня", като в Revolut
    ...
    "small_cap_gainers": 50,     # по-малки компании (пазарна кап. <2 млрд), не само megacap
    "aggressive_small_caps": 40,  # допълнителен пул от по-малки/по-волатилни имена
    "most_shorted_stocks": 35,   # висок % "къси" продажби -- склонни към резки short-squeeze пробиви нагоре, точно каквото гони тази стратегия
...
# Вдигнат до 300 (от 250) по изрична молба -- ВНИМАНИЕ: 300 е горната
# документирана безопасна граница. Yahoo е НЕофициален endpoint, не мисли
# за огромни групови заявки. Над ~300 тикъра расте рискът от throttling/
# грешки (429, прекъснати заявки), не просто по-бавен run. Ако видиш
# зачестили "Групово теглене се провали" съобщения в лога, свали го обратно.
